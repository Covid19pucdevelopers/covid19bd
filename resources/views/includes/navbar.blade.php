...
-->
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
                <form>
                    <!--begin: Head -->
                    <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(../../themes/metronic/theme/default/demo12/dist/assets/media/misc/bg-1.jpg)">
...
<span class="btn btn-success btn-sm btn-bold btn-font-md">23 new</span>
        ...
        <div class="kt-header__topbar-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                <form>
                    <!--begin: Head -->
                    <div class="kt-head kt-head--skin-dark" style="background-image: url(../../themes/metronic/theme/default/demo12/dist/assets/media/misc/bg-1.jpg)">
                        <h3 class="kt-head__title">
User Quick Actions 
...
<path d="M17.6011961,15.0006174 C21.0077043,15.0378534 23.7891749,16.7601418 23.9984937,20.4 C24.0069246,20.5466056 23.9984937,21 23.4559499,21 L19.6,21 C19.6,18.7490654 18.8562935,16.6718327 17.6011961,15.0006174 Z M0.00065168429,20.1992055 C0.388258525,15.4265159 4.26191235,13 8.98334134,13 C13.7712164,13 17.7048837,15.2931929 17.9979143,20.2 C18.0095879,20.3954741 17.9979143,21 17.2466999,21 C13.541124,21 8.03472472,21 0.727502227,21 C0.476712155,21 -0.0204617505,20.45918 0.00065168429,20.1992055 Z" fill="#000000" fill-rule="nonzero"/>
        ...
        <div class="kt-header__topbar-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                <form>
                    <!-- begin:: Mycart -->
                    <div class="kt-mycart">
                        <div class="kt-mycart__head kt-head" style="background-image: url(../../themes/metronic/theme/default/demo12/dist/assets/media/misc/bg-1.jpg);">
        ...
        Profile info, Timeline etc
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="../../themes/metronic/theme/default/demo12/dist/assets/media/products/product9.jpg" title="">
                                    </a>
                                </div>
                            </div>
        ...
        For PHoto & Others
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="../../themes/metronic/theme/default/demo12/dist/assets/media/products/product13.jpg" title="">
                                    </a>
                                </div>
                            </div>
        ...
        Profile info, Timeline etc
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="../../themes/metronic/theme/default/demo12/dist/assets/media/products/product16.jpg" title="">
                                    </a>
                                </div>
                            </div>
        ...
        For PHoto & Others
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="../../themes/metronic/theme/default/demo12/dist/assets/media/products/product15.jpg" title="" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    <i class="flaticon-grid-menu"></i>
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--langs">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                <span class="kt-header__topbar-icon">
<img class="" src="https://keenthemes.com/metronic/themes/metronic/theme/default/demo12/dist/assets/media/flags/226-united-states.svg" alt="" />
</span>
            </div>
                ...
                <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                    <li class="kt-nav__item kt-nav__item--active">
                        <a href="#" class="kt-nav__link">
                            <span class="kt-nav__link-icon"><img src="https://keenthemes.com/metronic/themes/metronic/theme/default/demo12/dist/assets/media/flags/226-united-states.svg" alt="" /></span>
                            <span class="kt-nav__link-text">English</span>
                        </a>
                    </li>
                    <li class="kt-nav__item">
                        <a href="#" class="kt-nav__link">
                            <span class="kt-nav__link-icon"><img src="https://keenthemes.com/metronic/themes/metronic/theme/default/demo12/dist/assets/media/flags/128-spain.svg" alt="" /></span>
                            <span class="kt-nav__link-text">Spanish</span>
                        </a>
                    </li>
                    <li class="kt-nav__item">
                        <a href="#" class="kt-nav__link">
                            <span class="kt-nav__link-icon"><img src="https://keenthemes.com/metronic/themes/metronic/theme/default/demo12/dist/assets/media/flags/162-germany.svg" alt="" /></span>
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                <div class="kt-header__topbar-user">
                    ...
                    <img alt="Pic" class="kt-radius-100" src="../../themes/metronic/theme/default/demo12/dist/assets/media/users/300_25.jpg" />
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                <!--begin: Head -->
                <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(../../themes/metronic/theme/default/demo12/dist/assets/media/misc/bg-1.jpg)">
                    <div class="kt-user-card__avatar">
                        <img class="kt-hidden" alt="Pic" src="../../themes/metronic/theme/default/demo12/dist/assets/media/users/300_25.jpg" />
                        <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
